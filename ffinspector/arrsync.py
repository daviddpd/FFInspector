...
def run_added_date_sync(
    ...
    try:
        adapter = _build_adapter(connection, normalized_app, media_extensions)
...
def _build_adapter(connection: sqlite3.Connection, app: str, media_extensions: Sequence[str]) -> _BaseArrAdapter:
    if app == "radarr":
        return _RadarrAdapter(connection, media_extensions)
    return _SonarrAdapter(connection, media_extensions)
